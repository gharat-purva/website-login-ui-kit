      ...
      <div className="w-1/2 flex items-center justify-center relative bg-turbo-blue">
        ...
        <div className="text-realwhite px-8 py-12 z-10">
          <div className="absolute top-4 left-4 flex items-center">
            ...
            <div className="h-8 w-8 bg-white rounded-full mr-2 flex items-center justify-center"></div>
        ...
        <div className="m-auto w-100">
          <div className="mb-6">
            <div className="m-auto">
              <p className="mt-3 font-semi-bold">
                Want to create an account? <a href="/sign-up" className="text-darkblue font-bold">Sign up</a>
              </p>
